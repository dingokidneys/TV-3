  ...
  function onOrientation(e) {
    ...
    // Modify pointer colour to indicate within +/-10° of transmitter
    if (selectedTx) {
      let diff = Math.abs(selectedTx.brg + smoothedAlpha) % 360;
      badptr = '#da6060';
      goodptr = '#00d4aa';
      if (diff <=5 ) {
          document.getElementById('cmpNote').style.color = goodptr;
          document.getElementById('pointerArrow').setAttribute('fill', goodptr);
          document.getElementById('polLabel').setAttribute('fill', goodptr);
      } else {
          document.getElementById('cmpNote').style.color = badptr;
          document.getElementById('pointerArrow').setAttribute('fill', badptr);
          document.getElementById('polLabel').setAttribute('fill', badptr);
      }
    }
  }
